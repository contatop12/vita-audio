...
const COMO_FUNCIONA_STEPS = [
  {
    title: "Agendamento",
    description:
      "Preencha o formulário no site. Assim que confirmado, você recebe o contato da nossa equipe imediatamente pelo WhatsApp.",
  },
  {
...
export function AparelhoAuditivoPage() {
