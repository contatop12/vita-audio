...
import { WHATSAPP_ROUTES } from "../constants/paths"
...
export function AudiometriaPageWA() {
  ...
  return (
    <>
      <HeroPage
        ...
        primaryLabel="Agendar Meu Exame pelo WhatsApp"
        ctaMode="whatsapp"
      />
      ...
      <PrimaryPromoBlock
        ...
        linkHref={WHATSAPP_ROUTES.zumbido}
