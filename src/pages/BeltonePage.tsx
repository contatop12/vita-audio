...
const POR_QUE = [
  ...
  {
    Icon: Ear,
    title: "Diferentes formatos e potências",
    description:
      "Opções para diferentes necessidades auditivas, preferências estéticas e níveis de potência, conforme o modelo.",
  },
  {
    Icon: BatteryCharging,
    title: "Opções de bateria",
    description:
      "Modelos com pilha convencional e modelos recarregáveis, conforme a linha escolhida. Consulte a disponibilidade.",
  },
  {
    Icon: Bluetooth,
    title: "Conectividade",
...
const LINHAS = [
  {
    ...
    description:
      "Uma das linhas Beltone trabalhadas pela clínica, com diferentes modelos e níveis de tecnologia dentro da própria família.",
    highlights: [
      "Formatos e níveis de tecnologia variam dentro da linha",
  ...
  {
    name: "Beltone Boost Ultra",
    tagline: "Maior potência",
    description:
      "Linha voltada a necessidades auditivas que demandam mais potência, quando houver indicação profissional.",
    highlights: [
      "Pensada para perdas auditivas de maior grau, conforme indicação",
      "A adequação é definida pela avaliação auditiva, não pela linha em si",
      "Consulte os modelos disponíveis e as características oficiais",
    ],
  },
  {
    name: "Beltone Achieve",
    tagline: "Linha disponível na Vita Audio",
    description:
      "Outra família Beltone trabalhada pela clínica, com opções que variam em formato, recursos e nível de tecnologia.",
    highlights: [
      "Diferentes formatos e recursos dentro da mesma família",
...
const COMPARATIVO_LINHAS = [
  {
    label: "Beltone Serene",
    values: ["Uma opção dentro do portfólio, conforme formato e tecnologia indicados"],
  },
  {
    label: "Beltone Boost Ultra",
    values: ["Necessidades auditivas que demandam maior potência, conforme indicação"],
  },
  {
    label: "Beltone Achieve",
...
const DIFERENCIAIS = [
  ...
  },
  {
    ...
    description:
      "Você entende o que muda entre as famílias Beltone antes de decidir qualquer coisa.",
  },
  {
...
const FAQ_ITEMS = [
  {
    question: "Aparelho auditivo Beltone é bom?",
    answer:
      "A Beltone possui diferentes linhas e níveis de tecnologia desenvolvidos para atender perfis variados de usuários. Porém, a experiência com um aparelho auditivo não depende apenas da marca: a escolha do modelo, o nível de tecnologia, a configuração, a adaptação e o acompanhamento profissional também são fundamentais.",
  },
  {
    question: "Quanto custa um aparelho auditivo Beltone?",
    answer:
  ...
  {
    question: "Quais são os aparelhos auditivos Beltone?",
    answer:
      "Na Vita Audio trabalhamos com as linhas Beltone Serene, Boost Ultra e Achieve. Dentro de cada família existem modelos com formatos, recursos e níveis de tecnologia diferentes.",
  },
  {
    question: "Qual é o melhor aparelho auditivo Beltone?",
    answer:
  ...
  {
    question: "O que é a linha Beltone Boost Ultra?",
    answer:
      "É a família voltada a necessidades auditivas que demandam maior potência. A indicação depende da avaliação auditiva — potência maior não significa, por si só, uma escolha melhor.",
  },
  {
    question: "Existe aparelho auditivo Beltone recarregável?",
    answer:
      "Existem modelos recarregáveis no portfólio de aparelhos auditivos atual. Consulte nossa equipe para confirmar quais opções recarregáveis Beltone estão disponíveis na Vita Audio.",
  },
  {
    question: "Aparelho auditivo Beltone tem Bluetooth?",
    answer:
  ...
  {
    question: "Existem aparelhos Beltone discretos?",
    answer:
      "O portfólio de aparelhos auditivos inclui formatos mais compactos. O quanto o aparelho fica visível depende do modelo, da anatomia do ouvido e da indicação para cada caso.",
  },
  {
    question: "Como saber qual Beltone é indicado para mim?",
    answer:
  ...
  {
    question: "Onde comprar aparelho auditivo Beltone em Indaiatuba?",
    answer:
...
const INTENCAO_OPTIONS = [
  {
    label: "Quero saber os preços dos aparelhos Beltone",
    message:
      "Olá! Gostaria de consultar os preços dos aparelhos auditivos Beltone disponíveis na Vita Audio.",
  },
  {
    label: "Quero conhecer a linha Serene",
    message:
      "Olá! Gostaria de saber mais sobre o Beltone Serene e consultar modelos e valores.",
  },
  {
    label: "Quero conhecer a linha Boost Ultra",
    message:
      "Olá! Gostaria de saber mais sobre o Beltone Boost Ultra e consultar modelos e valores.",
  },
  {
    label: "Quero conhecer a linha Achieve",
    message:
      "Olá! Gostaria de saber mais sobre o Beltone Achieve e consultar modelos e valores.",
  },
  {
    label: "Quero um aparelho recarregável",
    message:
      "Olá! Gostaria de conhecer os modelos Beltone recarregáveis disponíveis na Vita Audio.",
  },
  {
    label: "Não sei qual escolher",
    message:
      "Olá! Vi os aparelhos auditivos Beltone no site da Vita Audio e gostaria de conhecer os modelos e valores.",
  },
]
...
type BeltoneContentProps = {
  ctaMode: "form" | "whatsapp"
}

function BeltoneContent({ ctaMode }: BeltoneContentProps) {
  usePageMeta(PAGE_SEO.beltone)
  ...
  const ESCOLHA_STEPS = [
    ...
    },
    {
      ...
      description:
        "Entenda as diferenças entre as linhas Serene, Boost Ultra e Achieve e as tecnologias disponíveis.",
    },
    {
  ...
  return (
    <>
      <HeroPage
        title="Aparelhos Auditivos Beltone: Tecnologia para Diferentes Necessidades Auditivas"
        subtitle="Conheça as linhas Beltone Serene, Boost Ultra e Achieve e encontre, com orientação de fonoaudiólogas especializadas, o aparelho mais adequado para sua audição, rotina e preferências. Consulte modelos disponíveis e valores em Indaiatuba/SP."
        primaryLabel={wa ? "Conhecer Modelos Beltone pelo WhatsApp" : "Conhecer Modelos Beltone"}
        secondaryLabel={wa ? undefined : "Consultar Modelos e Valores"}
        ctaMode={ctaMode}
      />
      <FeatureCardGrid
        title="Por que escolher um aparelho auditivo Beltone?"
        subtitle="Uma marca com linhas distintas — o que importa é qual delas faz sentido para o seu caso."
        items={POR_QUE}
      />
      <CardsLinhas
        title="Conheça as linhas Beltone disponíveis na Vita Audio"
        ...
        ctaLabel="Quero Conhecer os Modelos Beltone"
        ctaMode={ctaMode}
        background="white"
      />
      <TabelaComparativa
        title="Qual aparelho auditivo Beltone escolher?"
      ...
      <FeatureCardGrid
        title="Aparelho auditivo Beltone recarregável"
        subtitle="A recarga elimina a troca frequente de pilhas pequenas. Consulte nossa equipe para saber quais modelos Beltone recarregáveis estão disponíveis."
      ...
      />
      <BlocoConteudo
        title="Aparelho auditivo Beltone é bom?"
        paragraphs={[
          "A Beltone possui diferentes linhas e níveis de tecnologia desenvolvidos para atender perfis variados de usuários. Porém, a experiência com um aparelho auditivo não depende apenas da marca. A escolha do modelo, o nível de tecnologia, a configuração, a adaptação e o acompanhamento profissional também são fundamentais.",
        ...
        closingText="Mais importante do que descobrir se a Beltone é boa de forma genérica é entender qual aparelho Beltone é adequado para você."
        ctaLabel="Quero Orientação para Escolher"
        ctaMode={ctaMode}
        background="gray"
      />
      <PrimaryPromoBlock
        title="Quanto custa um aparelho auditivo Beltone?"
        description="O preço de um aparelho auditivo Beltone varia conforme a linha, o modelo, o nível de tecnologia, os recursos e as necessidades de cada pessoa — Serene, Boost Ultra e Achieve podem ocupar faixas diferentes. Fale com nossa equipe e consulte modelos e valores disponíveis na Vita Audio."
        buttonLabel="Consultar Preços dos Aparelhos Beltone"
        ctaMode={ctaMode}
      />
      <BlocoConteudo
      ...
      />
      <DiferenciaisList
        title="Mais do que escolher um Beltone, é importante escolher o Beltone certo para você"
        items={DIFERENCIAIS}
      />
      <Section10bGoogleReviews />
      <Section09Conheca />
      <ComoFunciona
        title="Como escolher seu aparelho Beltone na Vita Audio"
        subtitle="Quatro passos, do primeiro contato ao acompanhamento da adaptação."
        steps={ESCOLHA_STEPS}
      />
      <FaqAccordion
        title="Dúvidas frequentes sobre aparelhos auditivos Beltone"
        items={FAQ_ITEMS}
      />
      <PaginasRelacionadas
        currentRoute="beltone"
        ctaMode={ctaMode}
        title="Veja também"
        background="white"
      />
      <OutrosServicos />
      <FinalCta
        title="Quer saber qual aparelho Beltone combina com suas necessidades?"
        subtitle="Conheça diferentes linhas, modelos e tecnologias Beltone e conte com a orientação das fonoaudiólogas especializadas da Vita Audio para encontrar uma opção adequada à sua audição, rotina e investimento. Atendimento em Indaiatuba/SP."
        primaryLabel="Consultar Modelos e Valores Beltone"
        ctaMode={ctaMode}
      />
    </>
  )
...
export function BeltonePage() {
  return <BeltoneContent ctaMode="form" />
}

export function BeltonePageWA() {
  return <BeltoneContent ctaMode="whatsapp" />
}
